...
console.log('   Go to: https://supabase.com/dashboard/project/vudqdubrlkouxjourunl/auth/url-configuration')
console.log('')
...
console.log('   • Authorized redirect URIs: https://vudqdubrlkouxjourunl.supabase.co/auth/v1/callback')
console.log('')
console.log('   Example:')
